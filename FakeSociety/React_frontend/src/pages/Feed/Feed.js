...
class Feed extends Component {
  ...
  loadPosts = direction => {
    ...
    fetch("http://localhost:8080/graphql", {
      headers: {
        // bearer is a convention for json web token.
        Authorization: "Bearer " + this.props.token,
        "Content-Type": "application/json"
      },
      method: "POST",
  ...
  finishEditHandler = postData => {
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then(fileResData => {
        ...
        let graphqlQuery = {
          query: `
          mutation CreateNewPosts($title: String!, $content: String!, $imageUrl: String!){
        ...
        if (this.state.editPost) {
          graphqlQuery = {
            query: `
            mutation UpdateExistingPostPosts($postId: ID!, $title: String!, $content: String!, $imageUrl: String!){
